...
export default function HeroSection() {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = "Abinash_Mallick_Resume.pdf";
    link.click();
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12 px-4 sm:px-8 lg:px-16 py-12 sm:py-16 lg:py-20 max-w-7xl mx-auto">
        <div className="flex-1 space-y-6 lg:space-y-8 w-full">
          ...
          >
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-indigo-400 min-h-[2rem] sm:min-h-[2.5rem]">
              {typewriterText}
              <span className="animate-pulse">|</span>
            </h2>
          </div>
          ...
          <p
            className={`text-slate-400 text-base sm:text-lg max-w-xl leading-relaxed transition-all duration-700 delay-300 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 -translate-x-8"
            }`}
          ...
          >
            {skills.map((skill, i) => (
              <span
                key={skill}
                className="px-3 sm:px-4 py-2 bg-white/5 backdrop-blur-sm border border-purple-500/30 rounded-lg text-xs sm:text-sm text-purple-300 hover:bg-white/10 hover:border-purple-400/50 hover:scale-105 transition-all duration-300 cursor-default"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                {skill}
              </span>
          ...
          >
            <button
              onClick={() => scrollToSection("projects")}
              className="group relative px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg font-medium text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] text-sm sm:text-base"
            >
              <span className="relative z-10">View My Work</span>
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="px-6 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg font-medium text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 text-sm sm:text-base"
            >
              Get In Touch
            </button>
            <button
              onClick={handleDownloadResume}
              disabled={isDownloading}
              className="px-6 py-3 bg-transparent border border-pink-500/50 rounded-lg font-medium text-pink-400 hover:bg-pink-500/10 hover:border-pink-400 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              {isDownloading ? (
                <>
                  <svg
          ...
          <div
            className={`flex gap-3 sm:gap-4 justify-center sm:justify-start transition-all duration-700 delay-600 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 -translate-x-8"
            }`}
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 sm:w-12 sm:h-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 hover:border-white/20 hover:scale-110 transition-all duration-300"
              title="GitHub"
            >
              <svg
        ...
        <div
          className={`flex-shrink-0 transition-all duration-1000 delay-300 ${
            isVisible
              ...
              : "opacity-0 translate-y-8 lg:translate-x-8"
          }`}
        >
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-500 rounded-3xl blur-xl opacity-60 animate-pulse" />
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500 mx-auto">
              <img
                src={profileImg}
                alt="Profile"
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <div className="absolute -top-4 -right-4 w-20 h-20 sm:w-24 sm:h-24 bg-purple-500/30 rounded-full blur-2xl animate-pulse" />
            <div
              className="absolute -bottom-4 -left-4 w-20 h-20 sm:w-24 sm:h-24 bg-pink-500/30 rounded-full blur-2xl animate-pulse"
              style={{ animationDelay: "1s" }}
            />
          </div>
        </div>
